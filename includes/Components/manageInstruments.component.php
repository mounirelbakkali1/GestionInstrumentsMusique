...
<div class="container-fluid mt-2">
    ...
    <?php foreach ($intruments as $inst) {
        ...
        if ($_SESSION['status'] == 2) {
            $actions = "<button class='btn rounded-circle delInstrBtn' id='del_".$inst['ID']."' style='background-color: #f18383;font-size: 11px '><i class='fas fa-light fa-trash-can text-light'></i></button>";
        } else {
            $actions = "";
        }
